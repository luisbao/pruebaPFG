 ...
 *
 * Descripción:
 *   Configuración de Tailwind CSS para el frontend. Aquí se
 *   definen las rutas que se escanean, el tema visual del
 *   proyecto, las variables de color y las animaciones comunes.
 * -----------------------------------------------------------
 */
    ...
    extend: {
      ...
      colors: {
        ...
        fashion: {
          ...
          terracotta: "hsl(var(--fashion-terracotta))",
